...
G_DECLARE_FINAL_TYPE(MpvradioBanner, mpvradio_banner, MENUTOOL, ITEM, GtkBox)


#define MPVRADIO_TYPE_BANNER            (mpvradio_banner_get_type ())
#define MPVRADIO_BANNER(obj)            (G_TYPE_CHECK_INSTANCE_CAST ((obj), MPVRADIO_TYPE_ITEM, MpvradioBanner))
#define MPVRADIO_BANNER_CLASS(klass)    (G_TYPE_CHECK_CLASS_CAST ((klass), MPVRADIO_TYPE_ITEM, MpvradioBannerClass))
#define MPVRADIO_IS_BANNER(obj)         (G_TYPE_CHECK_INSTANCE_TYPE ((obj), MPVRADIO_TYPE_ITEM))
#define MPVRADIO_IS_BANNER_CLASS(klass) (G_TYPE_CHECK_CLASS_CAST ((klass), MPVRADIO_TYPE_ITEM))
#define MPVRADIO_BANNER_GET_CLASS(obj)  (G_TYPE_INSTANCE_GET_CLASS ((obj), MPVRADIO_TYPE_ITEM, MpvradioBannerClass))
